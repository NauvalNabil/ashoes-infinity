...
<div class="p-6">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-white mb-2">Add New Hero Content</h1>
            <p class="text-gray-400">Create engaging banner content for your dashboard</p>
        </div>
                            ...
                            <div class="border-2 border-dashed border-slate-600 rounded-lg p-6 text-center hover:border-pink-500 transition-colors">
                                ...
                                <label for="background_image" class="cursor-pointer">
                                    <div id="upload-placeholder">
                                        ...
                                        <p class="text-gray-300 mb-1">Click to upload image</p>
